...
2.  Consider the simple hypothesis test corresponding to the question
3.  Determine the formulation to calculate sample size
4.  Extract parameters from tables or figures of the original paper
5.  Implement the formulation with extracted numbers
