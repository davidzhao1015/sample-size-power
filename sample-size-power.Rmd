...
1.  case study: beta-diversity
2.  case study: differential abundance analysis of a taxon
3.  case study: microbial cluster membership
4.  case study: taxon membership
...
To determine sample sizes for colonization with specific microbiota (presence/ absence or yes/ no), one can use the equations for proportions or odds ratios. 
